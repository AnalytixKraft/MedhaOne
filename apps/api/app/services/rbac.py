...
CORE_PERMISSIONS = (
    ...
    ("drug_license", "view", "drug_license:view"),
    ("drug_license", "verify", "drug_license:verify"),
    ("drug_license", "save_verified_data", "drug_license:save_verified_data"),
    ("drug_license", "history_view", "drug_license:history_view"),
    ("gst", "view", "gst:view"),
    ("gst", "verify", "gst:verify"),
    ("gst", "save_verified_data", "gst:save_verified_data"),
    ("gst", "history_view", "gst:history_view"),
    ...
    ("purchase_analytics", "view", "purchase_analytics:view"),
