...
import { createOrganization, deleteOrganization, listOrganizations, listOrganizationAuditLogs, resetOrganizationAdminPassword, updateOrganization, updateOrganizationMaxUsers, } from "../services/organization.service.js";
...
organizationsRouter.patch("/:organizationId/max-users", async (req, res, next) => {
    try {
        ...
        const organization = await updateOrganizationMaxUsers(req.auth.userId, req.params.organizationId, body.maxUsers);
