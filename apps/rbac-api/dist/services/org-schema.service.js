...
export async function createOrganizationSchema(client, schemaName, organizationName, admin) {
    await client.query(buildCreateTenantSchemaSql(schemaName));
    await client.query(`SET LOCAL search_path TO ${schemaName}, public`);
    await client.query(`INSERT INTO company_settings (id, company_name)
     VALUES (1, $1)
    ...
    await client.query(`INSERT INTO users (id, email, password_hash, full_name, role, is_active)
     ...
     ON CONFLICT (email) DO NOTHING`, [randomUUID(), admin.email, admin.passwordHash, admin.fullName]);
