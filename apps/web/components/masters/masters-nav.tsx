...
const links = [
  ...
  { href: "/masters/racks", label: "Rack Details" },
  { href: "/masters/drug-license-verification", label: "Drug Licence Verification" },
  { href: "/masters/gst-verification", label: "GST Verification" },
