...
export const INVENTORY_TABS: InventoryTabConfig[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: "racks",
        label: "Rack Details",
        description: "Define warehouse-wise rack details for receiving and put-away.",
        href: "/masters/racks",
        icon: Hash,
        requiredPermission: "masters:view",
      },
      {
        id: "drug-license-verification",
        label: "Drug Licence Verification",
        description: "Verify and attach party drug licence details with manual captcha assistance.",
        href: "/masters/drug-license-verification",
        icon: BadgeCheck,
        requiredPermission: "drug_license:view",
      },
      {
        id: "categories",
        label: "Master Settings",
        description: "Manage GST slabs, manufacturers, categories, and future tax controls.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "stock-source-traceability",
        label: "Stock Source Traceability",
        description: "Trace stock batches back to the supplier and purchase document chain.",
        href: "/reports/stock-source-traceability",
